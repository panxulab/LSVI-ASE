...
class FGPriorReplayBuffer(ReplayBuffer):
  ...
  def __getitem__(self, index: Union[slice, int, List[int], np.ndarray]) -> Batch:
    ...
    # to support np.array([FGPriorReplayBuffer()])
...
class FGPriorReplayBufferManager(FGPriorReplayBuffer):
  ...
  def __init__(self, buffer_list: List[FGPriorReplayBuffer]) -> None:
  ...
  def update(self, buffer: FGPriorReplayBuffer) -> np.ndarray:
...
class FGPriorVectorReplayBuffer(FGPriorReplayBufferManager):
  ...
  def __init__(self, total_size: int, buffer_num: int, **kwargs: Any) -> None:
    ...
    buffer_list = [FGPriorReplayBuffer(size, **kwargs) for _ in range(buffer_num)]
