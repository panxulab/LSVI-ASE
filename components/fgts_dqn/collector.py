...
from components.fgts_dqn.buffer import FGTSReplayBuffer as ReplayBuffer
from components.fgts_dqn.buffer import FGTSReplayBufferManager as ReplayBufferManager
from components.fgts_dqn.buffer import FGTSVectorReplayBuffer as VectorReplayBuffer


class FGTSCollector(Collector):
  """
  Collector for FGTS which also stores the first obs of each episode: (o_{1}, o_{t}, a_{t}, o_{t+1}, ...)
  """
  def __init__(
    self,
    policy: BasePolicy,
