...
from components.langevin_dqn import optim
...
class LangevinDQN(BaseAgent):
  ...
  def __init__(self, cfg):
    ...
    # Set optimizer
    assert self.cfg['optimizer']['name'] in ['LangevinAdam', 'AntiLangevinAdam'], \
     f"{self.cfg['optimizer']['name']} is not supported for Langevin DQN."
